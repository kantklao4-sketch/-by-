...
export const EraserIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.412 15.655 9.75 21.75l3.745-4.012M9.257 7.5H20.25L12 2.25 9.257 7.5Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 10.036 9.257 7.5l-3.25 9.75L3 10.036Zm10.605 1.182L17.25 15l-3.745-4.012-2.898 3.107Z" />
    </svg>
);
